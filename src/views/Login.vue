              ...
              <validation-observer ref="observer" v-slot="{ validate }">
                <form method="post">
                  ...
                  <div class="layui-form-item">
                    ...
                    <validation-provider name="password" rules="rulePassword" v-slot="{ errors }">
                      <div class="layui-input-inline">
                        <input
                          type="password"
                          name="password"
                  ...
                  <div class="layui-form-item">
                    ...
                    <validation-provider ref="codeProvider" name="code" rules="ruleCode" v-slot="{ errors }">
                      <div class="layui-input-inline">
                        <input
                          type="text"
                          name="code"
  ...
  methods: {
    ...
    async submit () {
      ...
      login(params).then(res => {
        ...
        if (res.code === 401) {
          this.$refs.codeProvider.setErrors([res.msg])
        }
      }).catch(err => {
